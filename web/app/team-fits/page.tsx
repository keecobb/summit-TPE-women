...
// app/[sport]/team-fits/page.tsx. Kept as a redirect (not deleted) so any
...
export default async function TeamFitsRedirect({
  searchParams,
}: {
  ...
  redirect(`/women/team-fits${suffix ? `?${suffix}` : ""}`);
}
