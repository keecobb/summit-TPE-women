...
// app/[sport]/teams/[id]/page.tsx. Kept as a redirect (not deleted) so any
...
// a team_id from the old pre-split single cache isn't guaranteed to
// resolve to the same team under the new per-sport caches -- this is a
...
export default async function TeamDetailRedirect({
  ...
  redirect(`/women/teams/${id}${suffix ? `?${suffix}` : ""}`);
}
