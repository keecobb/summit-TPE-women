// Content here doesn't differ by sport -- this route exists under [sport]/
// purely so the URL always carries the current sport segment (see
// components/MobileNav.tsx and ARCHITECTURE_HOSTING_PLAN.md's phase 16
// follow-up: without a sport segment on this page, the nav had no way to
// know which sport you were browsing and silently reset to women's on
// your next click). No `params` needed since nothing here reads `sport`.
const TERMS: { term: string; body: string }[] = [
  ...
  },
  {
    ...
    body:
      ...
      "candidate into a specific role on a target team instead of their own auto-projected minutes.",
  },
  {
