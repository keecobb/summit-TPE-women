"""Thin client for ESPN's public (unauthenticated) men's college
...
def list_teams(limit=500):
    """All D1 men's teams: [{'espn_id', 'name', 'abbreviation', 'conference_id'}]."""
    url = f"{BASE}/teams"
...
ATHLETE_BASE = "https://site.api.espn.com/apis/common/v3/sports/basketball/mens-college-basketball"
