"""Match Teams-sheet school names (D1 rows) to ESPN team IDs.
...
Usage:
    python scrapers/match_espn_teams.py
Writes:
    scrapers/espn_team_overrides.csv  (created empty on first run --
...
OVERRIDES_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "espn_team_overrides.csv")
...
def main():
    ...
    if unmatched:
        ...
        print("(find the ESPN team ID by searching espn.com/womens-college-basketball/team/_/id/XXXX/<school>)")
